...
class NavdataMessage():
    def __init__(self):
        self.gotAccelData = False
        self.accelerometer = AccelData(0,0,0)
        self.gotGyroData = False
        self.gyroscope = GyroData(0,0,0)

    @property
    def Accel(self):
        # If got no accelerometer data
        if (self.gotAccelData == False): return None
        return  self.accelerometer

    @property
    def Gyro(self):
        # If got no gyroscope data
        if (self.gotGyroData == False): return None
